...
import { c as PRODUCTS, o as LuxLink, u as Reveal } from "./catalog-BQPxniiu.mjs";
import { t as ImageEnquiryModal } from "./ImageEnquiryModal-aD1WXpNO.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/PlantFinder-B4cA-PYc.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
function Card({ p, index, onSelect }) {
	const desktopSpanClass = p.span === "tall" ? "md:row-span-2 md:min-h-[42rem]" : p.span === "wide" ? "md:col-span-2 md:aspect-[16/9]" : "";
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Reveal, {
		delay: index % 3 * .08,
		className: `w-full ${desktopSpanClass}`,
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "relative aspect-[4/3] w-full overflow-hidden bg-forest-deep mb-3",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
						src: p.image,
						alt: p.title,
						loading: "lazy",
						className: `h-full w-full object-cover ${p.fit === "contain" ? "object-contain bg-white p-3" : "object-cover"}`
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "absolute top-2.5 left-2.5 bg-black/75 px-2.5 py-1 text-[0.6rem] uppercase tracking-widest text-gold font-mono",
						children: p.category
					})]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
					className: "font-display text-xl text-forest font-semibold",
					children: p.title
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "mt-1.5 text-xs text-foreground/75 leading-relaxed font-sans line-clamp-2",
					children: p.copy
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "mt-4 border-t border-foreground/10 pt-3 flex items-center justify-between",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "text-[0.65rem] font-mono text-gold uppercase tracking-wider font-bold",
						children: "View Details & Specs"
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "bg-forest text-on-dark px-3 py-1.5 text-[0.65rem] font-mono uppercase tracking-wider font-bold",
						children: "Enquire"
					})]
				})
			]
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
					...
					loading: "lazy",
					className: `h-full w-full transition-transform duration-700 group-hover:scale-105 ${p.fit === "contain" ? "object-contain bg-white p-3 md:p-6" : "object-cover"}`
				}),
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
									src: p.image,
									alt: p.title,
									className: `h-full w-full transition-transform duration-700 group-hover:scale-105 ${p.fit === "contain" ? "object-contain bg-white p-3" : "object-cover"}`
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
