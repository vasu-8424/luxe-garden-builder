...
import { r as NAV_LINKS, t as BRAND } from "./site-E-V0XIIQ.mjs";
import { t as QueryClient } from "../_libs/tanstack__query-core.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/router-rWIZlSoJ.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				className: `font-display text-[1.05rem] xs:text-[1.15rem] sm:text-[1.35rem] md:text-[1.5rem] leading-none tracking-tight transition-colors duration-500 ${light ? "text-on-dark" : "text-forest"}`,
				children: "RR Heaven"
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				className: "eyebrow text-[0.68rem] sm:text-[0.68rem] tracking-[0.16em] text-gold pt-0.5",
				children: "Gardenblr"
			})]
		})]
	});
...
function SiteHeader() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("header", {
		className: `fixed inset-x-0 top-0 z-50 transition-all duration-700 ${scrolled || !overHero ? "glass-nav py-2 md:py-3.5" : "py-3 md:py-6"}`,
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "mx-auto flex max-w-[1400px] items-center justify-between px-3 sm:px-6 md:px-10",
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
						...
						className: `btn-lux inline-flex ${light ? "btn-ghost-light" : "btn-solid"} !px-2.5 !py-1.5 sm:!px-6 sm:!py-3 !text-[0.6rem] sm:!text-[0.68rem] font-mono`,
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Book" })
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "block h-[2px] w-4 bg-current" }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "block h-[2px] w-4 bg-current" }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "block h-[2px] w-4 bg-current" })
							]
						})
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "flex items-center justify-between border-b border-on-dark/15 pb-4",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
					...
					className: "font-display text-2xl text-on-dark block",
					children: "RR Heaven"
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					className: "text-[0.6rem] text-gold tracking-widest uppercase font-mono block",
					children: "Gardenblr"
				})] })]
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
				type: "button",
			...
			className: "mt-8 border-t border-on-dark/15 pt-6 space-y-3",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
					to: "/book-consultation",
					onClick: () => setOpen(false),
					className: "btn-lux btn-solid w-full justify-center py-3 text-xs uppercase font-mono",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Book Garden Consultation" })
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Call Us" })
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "WhatsApp" })
					})]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "eyebrow text-center text-stone/60 text-[0.65rem] pt-2",
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
								...
								className: "font-display text-2xl md:text-3xl leading-tight text-on-dark",
								children: ["RR Heaven ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "text-gold",
									children: "Gardenblr"
								})]
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "eyebrow text-gold/80 text-xs font-mono mt-1",
								children: "Landscape & Garden Studio"
							})] })]
						}),
...
var $$splitComponentImporter$9 = () => import("./routes-CJTchFuQ.mjs");
...
var $$splitComponentImporter$8 = () => import("./about-Cyxk2Fbn.mjs");
...
var $$splitComponentImporter$7 = () => import("./book-consultation-C9mJNfEv.mjs");
...
var $$splitComponentImporter$6 = () => import("./contact-DIYMi89I.mjs");
var title$6 = "Contact RR Heaven Gardenblr — Garden Nursery, Rajarajeshwari Nagar";
var description$6 = "Visit our nursery at BEML Layout, Rajarajeshwari Nagar, Bengaluru 560098. Open 7 working days, 7:30 AM – 10:00 PM. Call +91 9448276985 / +91 8088776985.";
...
var $$splitComponentImporter$5 = () => import("./gallery-NISgamEm.mjs");
...
var $$splitComponentImporter$4 = () => import("./privacy-policy-CaxIh6UH.mjs");
...
var $$splitComponentImporter$3 = () => import("./products-CB3wVklL.mjs");
...
var $$splitComponentImporter$2 = () => import("./projects-DVE08jZv.mjs");
...
var $$splitComponentImporter$1 = () => import("./services-D-XIMV7M.mjs");
...
var $$splitComponentImporter = () => import("./terms-C1L4hl5B.mjs");
