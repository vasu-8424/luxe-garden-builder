...
//#region node_modules/.nitro/vite/services/ssr/assets/ImageEnquiryModal-7cE7rkIr.js
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
									src: item.image,
									alt: item.title,
									className: `w-full object-cover transition-transform duration-500 cursor-zoom-in ${zoomed ? "scale-125" : "scale-100 h-64 sm:h-80 md:h-96"}`,
