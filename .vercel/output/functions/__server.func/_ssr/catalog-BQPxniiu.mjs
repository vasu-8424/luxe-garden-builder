...
//#region node_modules/.nitro/vite/services/ssr/assets/catalog-BQPxniiu.js
...
var hero_default = "/assets/hero-CP7mCzpo.jpg";
var about_default = "/assets/about-sFwCTi1Z.jpg";
var p_indoor_default = "/assets/p-indoor-B9cJ2ngS.jpg";
var p_outdoor_default = "/assets/p-outdoor-CxPqqyye.jpg";
...
var s_terrace_default = "/assets/s-terrace-Cpd7a1kW.jpg";
...
var after_default = "/assets/after-EcuSGbST.jpg";
		...
		specs: [
			{
				...
				value: "Insecticide & Fungicide Dual Action"
			},
			{
				label: "Target Pests",
				value: "Mealybugs, Scale, Aphids & Mites"
			},
			{
				label: "Disease Control",
				value: "Powdery Mildew & Leaf Spot"
			},
			{
				label: "Safety",
				value: "100% Pet, Child & Plant Safe"
			}
		]
	}
];
